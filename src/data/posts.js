...
// Préparation des données de posts filtrées selon le paramètre d'entrée, soit la catégorie
export const filterPostsByCategory = (selectedCategory) => {
  const selectedPosts = selectedCategory === 'Accueil'
    ? postsData
...
export const getPostBySlug = (slug) => {
  /* find fonctionne comme filter, sauf que cette fonction s'arrête au premier test qui renvoie true
  find renverra donc un seul résultat */
  const selectedPost = postsData.find(post => post.slug === slug);
  return selectedPost;
};
